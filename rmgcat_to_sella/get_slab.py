...
class GetSlab:
    ...
    def opt_fcc111(self):
        ...
        slab = fcc111(self.symbol, self.repeats, self.a, self.vacuum)
        GetSlab.prepare_slab_opt(self, slab)

    def opt_fcc211(self):
        ''' Optimize fcc211 slab '''
        slab = fcc211(self.symbol, self.repeats, self.a, self.vacuum)
        GetSlab.prepare_slab_opt(self, slab)

    def opt_fcc100(self):
        ''' Optimize fcc100 slab '''
        slab = fcc100(self.symbol, self.repeats, self.a, self.vacuum)
        GetSlab.prepare_slab_opt(self, slab)
