...
class Pynta:
    def __init__(self,path,rxns_file,surface_type,metal,label,launchpad_path=None,fworker_path=None,
        ...
        self.max_dist_hfsp = max_dist_hfsp
    ...
    def setup_transition_states(self,adsorbates_finished=False):
        ...
        # if irc_mode = "skip" : do not conduct IRC
            ...
            ts_task = MolecularTSEstimate({"rxn": rxn,"ts_path": ts_path,"slab_path": self.slab_path,"adsorbates_path": os.path.join(self.path,"Adsorbates"),
                    ...
                    "max_num_hfsp_opts":self.max_num_hfsp_opts, "max_dist_hfsp":self.max_dist_hfsp, "surrogate_metal":self.surrogate_metal,
        ...
        for coadname in self.coadsorbates:
            ...
            for st,E in coadmol_E_dict.items():
                ...
                if site_morph not in site_morph_to_energy_dict.keys() or site_morph_to_energy_dict[site_morph] > E:
                    site_morph_to_energy_dict[site_morph] = E / EV_TO_JMOL #convert from J/mol to eV
