...
#======== Custom surface generation + optimization + convergence test =====#
    ...
    #prep.generate_slab(a=a0) # this is for conventional slab
    #
    #a_opt, outavals, Evals = prep.calculate_lattice_parameters(return_scan=True)
    #prep.optimize_slab(a=3.89, c=None, slab_path=None, out_path="custom_slab.xyz") # this is for custom slab
#
    ...
    #)
    #kpts_results = prep.run_convergence_adsorbate(
    #    ecut_values=[40],
    #    kmesh_values=[(2,2,1), (3,3,1), (4,4,1)],
    #    adsorbate=None,
