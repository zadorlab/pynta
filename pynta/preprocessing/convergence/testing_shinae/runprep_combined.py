# combined_preprocessing_site_analysis.py
import os
import json
import time
import inspect
...
class Prep:
    ...
    def calculate_alloy_lattice_parameters(self, da=0.1):
        """
        NEW behavior:
          - If alloy_path is provided: read xyz into atoms0 and optimize its isotropic scale.
          - Else: build ordered alloy via build_ordered_alloy_cubic() using alloy_A/B/xA.
        """
        ...
        # ---- Case 1: use alloy_path if provided ----
        ...
        # ---- Case 2: build ordered alloy if no path ----
        else:
